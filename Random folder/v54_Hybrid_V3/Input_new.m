...
p.dy = 0.05;                                       % Spacing between adjacent DP propulsors, as fraction of propulsor diameter [-]
...
m.cr.f = 0.995;                                  % Cruise weight fraction W/MTOW [-]
...
m.L.f = 0.990;                                   % Landing weight fraction W/MTOW [-]
...
m.TO.Phi = 0.6;                                % TO shaft power ratio [-]
 
% OEI Balked landing
m.bL.G = 0.021;                                 % OEI balked landing climb gradient [-] (CS25.121d)
m.bL.f = 0.99;                                   % Max landing weight (MLW) as a fraction of MTOW [-]
...
m.cI.phi = 0.01;                                % OEI-ceiling landing supplied power ratio [-]
...
MA_in.cl.xi = [0.7 0.9];
MA_in.cl.phi = [0.03 0.03];
MA_in.cl.Phi = [0.3 0.3];
