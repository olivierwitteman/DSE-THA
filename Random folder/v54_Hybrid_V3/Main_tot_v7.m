...
% end
% check wether the cd0s converge
total_cD0
CD0_clean
...
Cr_h = 2*Sh/((1+lambda_h)*bh);  % <----- INPUT    NOT NEEDED
...
Pbr= 326; %shaft horse power of one engine 132HP = 99000W (Rotax 915) (ASSUMED) % <----- INPUT
