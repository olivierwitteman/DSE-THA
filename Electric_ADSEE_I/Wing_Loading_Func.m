function [] = Wing_Loading_Func(h, A ,e_clean,cd0_clean, Cl_max, cl_to ,c, V_land, V_stall, V_cruise, MTOW)
clc;
...
for i = Cl_max % CHANGE CL_LAND_GROUP# ACCORDING TO YOUR GROUP
    WS_land = i*rho_0*s_land/(0.5915)/(2*1);   % CHANGE f_group# to your group
