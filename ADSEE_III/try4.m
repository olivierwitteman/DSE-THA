...
mu_3=0.55-0.5;% accounts for the effect of sweep angle
...
Cmac_nac = 0.2*0; %assumed pitching moment coefficient at aerodynamic center (please estimate correctly when engine data available)
%for nacelle
